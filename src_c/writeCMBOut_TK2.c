...
//begin  WSO 9/15/13 
extern float ___missingmod_MOD_missing_r4;
#define missing_r4c __missingmod_MOD_missing_r4
extern short ___missingmod_MOD_missing_i2;
#define missing_i2c ___missingmod_MOD_missing_i2
extern long __missingmod_MOD_missing_i4;
#define missing_i4c ___missingmod_MOD_missing_i4
extern int __nbinmod_MOD_ntransition;
#define ntransitions ___nbinmod_MOD_ntransition
//end    WSO 9/15/13
#endif
