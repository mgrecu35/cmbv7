...
OPENMPGF = -fopenmp
FOPTS   = -c -g -fPIC -O2 $(OPENMPGF)
F77OPTS = -c -g -fPIC -O2 $(OPENMPGF)
CFLAGS  = -O2 
C++FLAGS= -O2 $(OPENMPGF)
...
LIB = -L/Users/mgrecu/multiscatter-1.2.10/lib


LIBES =  -lgfortran  -llapack 


#---Compile Stages
OBJ =	readTables_nonsph.o \
	bisection.o f90DataTypes.o  random.o  writegif.o nbin.o \
	weightModule.o	 globModule.o \
	lut_routines_sjm.o\
...
test_1CGMI_h5.o:	src_c/test_1CGMI_h5.c
	        $(CC) $(INC) -c -O2 src_c/test_1CGMI_h5.c

main.C.o: src_c/main.C.c
						 $(CC) $(INC) -c -O2 src_c/main.C.c

readDPR.o: src_c/readDPR.c
						 $(CC) $(INC) -c -O2 src_c/readDPR.c
...
mainfpy.o:	src_f90/mainfpy.f90	
		$(F90) $(F77OPTS)  src_f90/mainfpy.f90
...
multiscatter2_ascii.o:	src_c/multiscatter2_ascii.c 
		$(CC) -I/Users/mgrecu/multiscatter-1.2.10/include -c -O2 src_c/multiscatter2_ascii.c
...
convRet.o:		src_f90/convRet.f90	
		$(F90) $(F77OPTS)  $(OPENMP) src_f90/convRet.f90

hbprof_new.o:		src_f90/hbprof_new.f90	
		$(F90) $(F77OPTS)  $(OPENMP) src_f90/hbprof_new.f90
...
augLagrange.o:	gEnv.o src_f90/augLagrange.f90
		$(F90) $(FOPTS) $(OPENMP) src_f90/augLagrange.f90
...
stratiform.o:	src_c/stratiform.c
		$(CC) -c -O2 src_c/stratiform.c
